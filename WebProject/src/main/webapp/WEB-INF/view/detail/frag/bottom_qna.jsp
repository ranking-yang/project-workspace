...
<div class="main_tab_wrap">
	...
	<div class="viewpage_content">
		※ 환불/취소요청은 <span class="viewpage_link">마이티켓 &gt;	환불신청</span></a>, 
		이용 불편 및 요청사항은 <span class="viewpage_link">1:1문의</span></a>를 이용해주세요.
	</div>
	...
	<div id="qna_text_container">
		<c:forEach var="qna" items="${qnalist }">
			<div class="qna">
				...
				<div class="qna_answer"><c:if test="${qna.qa_answer ne null }"><span class="ans">┗  A</span>    ${qna.qa_answer }</c:if></div>
			</div>
		</c:forEach>
	</div>
	</div>