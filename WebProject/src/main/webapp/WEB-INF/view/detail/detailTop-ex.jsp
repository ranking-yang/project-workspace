...
<!-- body -->
	<div class="detail-top-con">                <!-- product-list로 돌아감 -->
        <div class="detail-top-now-category">📁 <a href="/product/performance?main_category=${performance.main_category}">${performance.main_category} > </a></div> <!-- 카테고리 -->
        ...
        <div class="detail-top-right">
			<div class="popup-option">
	            ...
	            <input type="button" id="popup-option-btn" name="booking_date" value="[유효기간 ~ ${performance.end_date}]" readonly/>
	        </div>
            <div class="popup-qty">
                <!-- 권종/수량 -->
