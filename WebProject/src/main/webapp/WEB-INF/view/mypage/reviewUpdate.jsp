...
<body>
	<div class="review-box">
				<input type="hidden" name="review_code"
					value="${review.review_code}" form="form"/>
    <h3>관람은 만족하셨나요?</h3>
    <input type="hidden" id="review_star" name="review_star" form="form" value="${review.review_star}" />
    ...
    <h3>만족한 부분을 적어주세요</h3>
    <textarea form="form" id="writeNote" name="review_content" style="resize:none;" rows="10" cols="55">${review.review_content}</textarea>
    <button class="submit" id="popupButton" onclick="popup();" type="button" form="form">작성완료</button>
    <form action="/mypage/review/update" method="post" id="form"></form>
  </div>
