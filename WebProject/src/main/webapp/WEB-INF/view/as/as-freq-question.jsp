...
<body>
    <div id="as-container">
        <div id="as-side-menu">
            ...
            <div id="freq-questions"class="as-side-menu-subtitle selected">자주 묻는 질문</div>
        ...
        <div id="as-board">
            ...
            <div id="freq-questions-top3-container">
                <div class="freq-question-top3-module">
                    <div class="freq-q-top3-icon"><img src="/resources/as/images/freq-q-refund-icon.png" alt=""></div>
                    <div class="freq-q-top3-title"><span class="freq-q-span">Q</span> 자주 묻는 질문 1번째 제목</div>
                </div>
                <div class="freq-question-top3-module">
                    <div class="freq-q-top3-icon"><img src="/resources/as/images/freq-q-ticket-icon.png" alt=""></div>
                    <div class="freq-q-top3-title"><span class="freq-q-span">Q</span> 자주 묻는 질문 2번째 제목</div>
                </div>
                <div class="freq-question-top3-module">
                    <div class="freq-q-top3-icon"><img src="/resources/as/images/freq-q-receipt-icon.png" alt=""></div>
                    <div class="freq-q-top3-title"><span class="freq-q-span">Q</span> 자주 묻는 질문 3번째 제목</div>
                </div>
            </div>
