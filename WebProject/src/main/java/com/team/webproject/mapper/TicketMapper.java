...
public interface TicketMapper {
	...
	TicketDetailDTO getTicketDetail_hasCoupon(String payment_code);
	
	List<TicketRefundDTO> getRefundTickets(Integer booker_code);
	
	TicketRefundDTO getRefundTicketDetail(String payment_code);
	
	TicketRefundDTO getRefundTicketDetail_hasCoupon(String payment_code);
	...
	int updateReviewCode(int review_code, String payment_code);
	
	int deleteReviewCode(Integer review_code);
