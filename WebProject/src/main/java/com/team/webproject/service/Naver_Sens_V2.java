...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "qYh6HapGxzvX8sOMNZlq";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "LPj0vUhIbPGf83GPzSaIT5PjqUdcZwiyPAxm9Q9K";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:280775754349:web_project";
        // 요청 method
        String method = "POST";
        ...
        // 난수와 함께 전송
        toJson.put("content","티켓킹 본인인증입니다.\n"
        		+ "인증번호: ["+rand+"]을 입력해주세요.");		
        toJson.put("to",tel);
        toArr.add(toJson);
