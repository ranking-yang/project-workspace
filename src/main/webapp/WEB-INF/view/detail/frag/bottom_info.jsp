	...
	<div class="main_tab_wrap">
		...
		<div>
			...
			<div class="viewpage_text radius_box">
				...
				<div>· 좌석배정: 비지정석 (타 예매처 지정석 제외 후 매표소 선착순 배정)</div>
		...
		<div>
			...
			<div class="viewpage_text radius_box">
				...
				<div>· 지각으로 인해 관람하지 못할 시 환불 불가</div>
				<div>· 지역착오, 연령 미숙지로 관람하지 못할 시 환불 불가</div>
				<div>· 음식물 반입 금지. 공연 중 사진/동영상 촬영 금지</div>
				<div>· 모든 티켓은 변경이 불가하며, 환불만 가능</div>
				<div class="txt_red">· 관람 당일은 결제 후 환불 불가하니 신중히 예매하세요.</div>
			</div>
		</div>
